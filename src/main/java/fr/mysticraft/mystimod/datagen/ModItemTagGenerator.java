...
public class ModItemTagGenerator extends ItemTagsProvider {
    public ModItemTagGenerator(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider,
        ...
        super(pOutput, pLookupProvider, pBlockTags, MystiMod.MOD_ID, existingFileHelper);
    }

    @Override
    protected void addTags(HolderLookup.Provider pProvider) {
        this.tag(ItemTags.TRIMMABLE_ARMOR)
                .add(ModItems.MYSTIQUARTZ_HELMET.get(),
                        ModItems.MYSTIQUARTZ_CHESTPLATE.get(),
                        ModItems.MYSTIQUARTZ_LEGGINGS.get(),
                        ModItems.MYSTIQUARTZ_BOOTS.get());
