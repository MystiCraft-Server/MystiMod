...
public enum ModArmorMaterials implements ArmorMaterial {
    MYSTIQUARTZ("mystiquartz", 26, new int[] { 7, 9, 7, 6 }, 25,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 3f, 0f,
            () -> Ingredient.of(ModItems.MYSTIQUARTZ.get()))
    ...
    public String getName() {
        return MystiMod.MOD_ID + ":" + this.name;
    }
